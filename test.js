...
window.onload = function () {
  ...
  function paintBoard() {
    ...
    for (var i = 0; i < 9; i++) {
      for (var j = 0; j < 9; j++) {
        if (board[i][j] === EMPTY) test.append("*   ");
        else test.append(board[i][j] + "    ");
      }
      test.append("<br>");
    }
    ...
    for (var i = 0; i < 9; i++) {
      for (var j = 0; j < 9; j++) {
        if (backupBoard[i][j] === EMPTY) test.append("*   ");
        else test.append(backupBoard[i][j] + "    ");
      }
      test.append("<br>");
    }
    ...
    for (var i = 0; i < 9; i++) {
      for (var j = 0; j < 9; j++) {
        if (testBoard[i][j] === EMPTY) test.append("*   ");
        else test.append(testBoard[i][j] + "    ");
      }
      test.append("<br>");
    }
  }
